...
struct Calisan { //Gruplastirma ile ileride karakter girdisi yapacagiz.
    int id; 
    string adi;
    string birimi; 
};

void isci(Calisan eleman){ //Burada fonksiyon atamasi için koydum. Mesela eleman1 burada bulunuyor.
...
int Ulas=53; //global bir değisken
int Eslem=77; //global bir degisken
